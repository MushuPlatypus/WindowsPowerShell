...
#>
  ...
  $web_files = New-Object System.Text.RegularExpressions.Regex(
      '\.(css|js|less)$', $regex_opts)
  $media_files = New-Object System.Text.RegularExpressions.Regex(
      '\.(png|jpg|jpeg|ttf|woff|eot|svg|mp4|mp3|m4v|wav|mpg|wmv|wma)$', $regex_opts)
  ...
  Invoke-Expression ("Get-ChildItem $args") |
    %{
      if ($_.GetType().Name -eq 'DirectoryInfo') {
        ...
        echo $_
        $Host.UI.RawUI.ForegroundColor = $fore
      } elseif ($web_files.IsMatch($_.Name)) {
